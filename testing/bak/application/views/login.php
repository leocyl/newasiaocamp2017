      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>loginMe" method="post">
          ...
          <div class="form-group has-feedback">
            ...
            <input type="text" class="form-control" placeholder="用戶名稱" name="email" required /><!---->
        ...
        <br><p>如忘記密碼，請致電或WhatsApp <a>Leo 9606 4178</a></p>
