...
class User extends BaseController
{
    ...
    function obtainBlokus()
    {
        ...
        $this->loadViews("obtainBlokus", $this->global, NULL, NULL);
    }
    ...
    function provideBlokus()
    {
        ...
        $this->loadViews("provideBlokus", $this->global, NULL, NULL);
    }
    ...
    function tasksUpload()
    {
        
        $this->global['pageTitle'] = '新亞書院迎新營';

        $this->loadViews("tasksUpload", $this->global, NULL);
    }
